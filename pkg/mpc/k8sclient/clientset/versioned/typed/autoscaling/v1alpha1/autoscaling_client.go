...
import (
	...
	"nanto.io/application-auto-scaling-service/pkg/mpc/k8sclient/clientset/versioned/scheme"
)

type AutoscalingV1alpha1Interface interface {
	RESTClient() rest.Interface
	CustomedHorizontalPodAutoscalersGetter
}

// AutoscalingV1alpha1Client is used to interact with features provided by the autoscaling.cce.io group.
type AutoscalingV1alpha1Client struct {
	restClient rest.Interface
}

func (c *AutoscalingV1alpha1Client) CustomedHorizontalPodAutoscalers(namespace string) CustomedHorizontalPodAutoscalerInterface {
	return newCustomedHorizontalPodAutoscalers(c, namespace)
}
